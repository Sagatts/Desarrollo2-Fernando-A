            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php $imagen = $row['archivo']; echo isset($Imagen_perfil) ? "<img src='$imagen' width='100' height='100'>" : "<p>Imagen no disponible</p>"; ?></td>
                    </tr>
                <?php
                }
                ?>
    ...
    <!--Horario-->
        ...
        <div class="horario ">
            ...
            <div class="recuadrohorario">
                ...
                <button id="btnModificar" class="botonestabla">bloquear celdas</button>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($queryTesis)) { ?>
                    <tr>
                        <td><?php echo $row['titulo'] ?></td>
                        <td><?php echo $row['anio'] ?></td>
                        <td><?php $link = $row['link'];echo "<a href=\"$link\">$link</a>"; ?></td>
                    </tr>
                <?php
                }
                ?>
